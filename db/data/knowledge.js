...
window.WIKI_DATA = [
  ...
  },
  {
    ...
    "items": [
      ...
      {
        "text": "韩语口语中，「-느라고」常被误读或误写成「-느냐고」（快速口语中发音易混淆），而该语境下的标准语法表达应为「-느라고」。语法辨析：① 「-느라고」（标准表达）接在动词词干后，表示“因为忙于做某事（消耗了时间/精力），导致了后面的某种（通常是负面或不便的）结果”，常译为“因为……所以（没能）……”；前后句主语需一致，后句常出现“没时间、很忙、没能做……”等表达。例句：일하느라고 전화를 못 받았어요.（因为工作，没接到电话。）② 「-느냐고」（被误用的形式）用于动词（现在时），表示间接引语中的疑问句，即“问是否……”“问有没有……”。例句：밥을 먹느냐고 물었어요.（问了有没有在吃饭/问了是否吃饭。）出现这种“习惯错误”的原因：日常韩语口语中「-느라고」经常被快速连读，发音容易含糊，听起来很像在询问“是不是在做什么”。"
      }
    ]
  }
];
