/*:
 * @plugindesc Allows developers to set up automatic updates to occur whenever a player plays the game.允许开发者在玩家玩游戏时设置自动更新。
 * @author SumRndmDde
 *
 * @param Update Text URL更新文字网址
 * @desc The URL for the game to download the "Update Text" file which determines which files need to be updated.游戏的URL下载“更新文本”文件，该文件确定哪些文件需要更新。
 * @default
 *
 ...
 * 这个插件允许开发者设置自动更新，以便在互联网可用时玩家玩游戏。
 *
 *
 * ==============================================================================
 *  Install a Background Image!!安装背景图像！
 * ==============================================================================
 *
 ...
 *
 * ==============================================================================
 *  How to Set up MASTER Text File 如何设置主文本文件
 * ==============================================================================
 *
 * In order to create orders and information the game can access online to use
 * in order to update, you must host a text file online. 
 * 为了创建游戏可以在线访问以用于更新的订单和信息，您必须在线提供文本文件。
 * I would recommend using GitHub. Once the text file is hosted online, place the 
 * direct link into the "Update Text URL" Parameter.
 * 我会推荐使用GitHub。 一旦文本文件在线托管，将直接链接放入“更新文本URL”参数中。
 *
 * In order to create an update for the game, simply use the following notetag:
 * 为了创建游戏更新，只需使用以下notetag：
 *
 *   <Version: ###>
 *   <End of Version>
 *
 ...
 * 将“###”替换为您希望创建的版本号。
 * 如果客户端游戏的版本号小于该数字，则会下载版本标签中包含的所有链接。
 *
 *
 * ==============================================================================
 *  Setting up Version Downloads 设置版本下载
 * ==============================================================================
 *
 ...
 * 如果您在主文本中输入完整的notetag，则所有连接到互联网的游戏将从wordpress.org
 * 下载文件并将其保存在 /data/ 文件夹中，并将其命名为“test.zip”。
 *
 ...
 * 如果你想再次更新游戏，你需要创建一个新的notetag（不要擦除旧的），甚至更新的链接。
 * 如果游戏在更新中落后，则会下载所有数字高于游戏当前版本号的更新！
 *
 *
 * ==============================================================================
 *  End of Help File 帮助文件的结束
 * ==============================================================================
 * 
