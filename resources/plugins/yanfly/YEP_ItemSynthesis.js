...
//=============================================================================
 /*:
 * @plugindesc v1.09 可以在游戏内通过合成系统制作物品
 ...
 * @on YES
 * @off NO
 * @desc 隐藏未合成物品名称的文本以斜体显示。
 * @default true
 *
 * @param 隐藏帮助文本
 * @parent ---列表窗口---
 * @desc 如果物品被隐藏，这会在帮助窗口中显示的文本。
 ...
 * ============================================================================
 *
 * 物品合成现在是大多数角色扮演游戏一个很常见的方面，玩家可以在获取配方后制作物品
 * 该插件可让玩家在获取所需配方后能够做到这一点。
 * 配方可以以物品，武器和/或防具的形式出现，并转录成物品，武器和/或防具。
 * 这些物品可以从主菜单和/或合成单位中制作！
 *
 * ============================================================================
 * Notetags 备注
 * ============================================================================
 *
 * 为了让玩家能够制作某个物品，该物品必须包含在玩家拥有的的配方中。
 *
 * 物品，武器，防具备注:
 *   <Item Recipe: x>
 *   <Item Recipe: x, x, x>
 *   <Item Recipe: x to y>
 *   将此物品变为物品 x 的配方
 *   只要拥有这个物品，并有足够的材料，就可以合成物品 x
 *   * 注意: 没有名称的项目，没有合成消耗和/或没有材料列表的项目不能合成
 *  
 *   <Weapon Recipe: x>
 *   <Weapon Recipe: x, x, x>
 *   <Weapon Recipe: x to y>
 *   将此武器变为物品 x 的配方
 *   只要拥有这个武器，并有足够的材料，就可以合成物品 x
 *   * 注意: 没有名称的项目，没有合成消耗和/或没有材料列表的项目不能合成
 *
 *   <Armor Recipe: x>
 *   <Armor Recipe: x, x, x>
 ...
 *     named item: x
 *   </Synthesis Ingredients>
 *   在物品上使用上面的备注，将这个物品改为玩家所需要的材料
 *   将 id 替换成适当的物品，武器或防具ID。 
 *   如果没有指定ID, 数据库会自动默认为只需要任何一个物品就能合成
 *   如果指定了货币(gold)，那么在合成的时候需要消耗相同量的货币
 *   
 *   如果你使用已经被命名的项目，那么会以物品,武器,防具的顺序优先使用最高ID
 *
 *   *注意：如果你使用了 Item Core，独立物品不能作为合成材料，因此会自动忽略
 * 
 *   <Mask Name: x>
 *   如果隐藏了物品名字，未知物品的名字将显示为 ID为 x 的物品的名字
 *   这可以让游戏使用的隐藏物品名称不是通常的???(如果你使用的是这个)来隐藏这个物品
 *   这可以让玩家想要的成品显示为 “奇怪的液体” 或者 “怪异的水晶”
 *   
 *
 * ============================================================================
 * 疯狂模式 Lunatic Mode  - 自定义合成效果
 * ============================================================================
 *
 * 有JavaScript经验的用户，可以使用这些备注来制作合成特定物品时会发生的自定义效果
 * 例如，当制作药水时，可以给玩家一个空瓶作为合成的副产物。
 *
 * ---
 *
 * 物品，武器，防具备注:
 ...
 *   </Custom Synthesis Effect>
 *
 *   对于这个备注，'item'变量将被引用为合成的物品
 *   改变它将不会做任何事情，但它将被用作一个方便引用的变量
 *
 * ---
 *
 * ============================================================================
 ...
 *
 * 可以使合成菜单在打开时只允许物品 15，武器 20 或 护甲30的配方，
 * 不需要且不显示在玩家拥有的配方中
 *
 * ============================================================================
 * 更新日志
