 ...
 *   ItemBook add weapon 3    # 增加#3武器到物品图鉴
 *   ItemBook add armor 4     # 增加#4防具到物品图鉴
 *   ItemBook remove armor 5  # 移除#3武器到物品图鉴
 *   ItemBook remove item 6   # 移除#4防具到物品图鉴
 *   ItemBook complete        # 完成物品图鉴
 *   ItemBook clear           # 清空物品图鉴
 *
 * 物品(武器,防具)注释:
 *   <book:no>                # 该物品不会出现在物品图鉴中
 */
