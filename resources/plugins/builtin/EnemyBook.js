 ...
 *
 * 插件命令:
 *   EnemyBook open         # 打开怪物图鉴
 *   EnemyBook add 3        # 增加#3怪物到怪物图鉴
 *   EnemyBook remove 4     # 移除#4怪物从怪物图鉴
 *   EnemyBook complete     # 完成怪物图鉴
 *   EnemyBook clear        # 清除怪物图鉴
 *
 * 怪物注释:
 *   <desc1:foobar>         # 怪物图鉴中描述文字第一行
 *   <desc2:blahblah>       # 怪物图鉴中描述文字第二行
 *   <book:no>              # 这些怪物不出现在怪物图鉴
 */
